package lk.ijse.hostel_management_hibernate.controller.util;
...
public class AlertController {
    ...
    public static boolean successfulMessage(String msg) {
        ...
        Stage stage = (Stage) alert.getDialogPane().getScene().getWindow();
        stage.getIcons().add(new Image("/assets/images/wdoneIcon.png"));
    ...
    public static void exceptionMessage(String msg) {
        ...
        Stage stage = (Stage) alert.getDialogPane().getScene().getWindow();
        stage.getIcons().add(new Image("/assets/images/warningIcon.png"));
